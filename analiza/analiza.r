...
vse_nocitve_pr <- vse_nocitve_pr %>% filter(leto != 2010, leto != 2011, leto != 2012, leto != 2013, leto != 2014, leto != 2015)
...
vsa_potovanja_pr <- vsa_potovanja_pr %>% filter(leto != 2010, leto != 2011, leto != 2012, leto != 2013, leto != 2014, leto != 2015)
